...
| **Sentinel Data Lake** (`mcp_microsoft_se2_*`) | ❌ NO | Not available |
| **Advanced Hunting / Triage MCP** (`mcp_mtp_mcp_servi_*`) | ❌ NO | Not available |
| **Microsoft Graph MCP** (`mcp_microsoft_ent_*`) | ❌ NO | Not available |
