...
1. **send-email-report**: title "🕸️ Exposure Graph ({date})", verdict color, attach HTML, 5 cards + path narrative.
2. **send-teams-notification**: Adaptive Card with exposure verdict, blast radius, top crown jewels at risk.
