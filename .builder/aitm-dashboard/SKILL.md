...
1. **send-email-report**: title "🎣 AiTM Dashboard ({date})", verdict color, attach HTML, 5 metric cards + top targets.
2. **send-teams-notification**: Adaptive Card with verdict, score, top flagged users.
