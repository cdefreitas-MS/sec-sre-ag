...
| **Sentinel Data Lake** (`mcp_microsoft_se2_*`) | ❌ NO | Cannot execute queries directly — suggest query for user to copy/paste |
| **Advanced Hunting / Triage MCP** (`mcp_mtp_mcp_servi_*`) | ❌ NO | Cannot execute queries directly — suggest query for user to copy/paste |
| **Microsoft Graph MCP** (`mcp_microsoft_ent_*`) | ❌ NO | Cannot query Graph API directly — suggest API calls or portal steps |
