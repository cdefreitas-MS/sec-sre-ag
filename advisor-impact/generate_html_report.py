...
_REPORT_CSS = """
  ...
  *{box-sizing:border-box}
  ...
  .m365slicers{display:flex;flex-wrap:wrap;gap:10px}
...
function m365UpdateBtn(dim){var btn=document.querySelector('.slicer-btn[data-dim="'+dim+'"]');if(!btn)return;var s=m365SelDim(dim);btn.querySelector(".valtxt").textContent=!s.size?"Todos":(s.size===1?[...s][0]:s.size+" selecionados");btn.classList.toggle("on",s.size>0);}
